...
@section('content')
    ...
    <section class="position-relative overflow-hidden"
        style="background-color: var(--sharesa-dark); padding-top: 150px; padding-bottom: 100px; margin-top: -85px;">
        ...
        <div class="container position-relative z-1">
            <div class="row align-items-center">
                <div class="col-lg-7 text-white">
                    {{-- Badge --}}
                    <div
                        class="d-inline-flex align-items-center rounded-pill px-3 py-1 mb-4 border border-white border-opacity-25 bg-white bg-opacity-10 shadow-sm">
                        <span class="badge rounded-pill me-2 fw-bolder"
                            style="background-color: var(--sharesa-green); color: var(--sharesa-dark);">NEW</span>
                    ...
                    <div class="d-flex gap-3 flex-column flex-sm-row">
                        <a href="#" class="btn btn-sharesa-primary btn-lg px-5 py-3 shadow-lg hover-up fw-bold wa-track"
                        ...
                        <a href="{{ url('/portfolios') }}"
                            class="btn btn-outline-light btn-lg px-5 py-3 rounded-pill hover-up">
                            {{ __('messages.hero_secondary') }}
                        </a>
                    </div>

                    {{-- Stats Mini --}}
                    <div class="row mt-5 pt-4 border-top border-white border-opacity-10 g-5">
                        <div class="col-auto me-lg-5 me-4">
                            <h2 class="display-6 fw-black text-white mb-1">50<span
                                    style="color: var(--sharesa-green);">+</span></h2>
                            <p class="text-white-50 text-uppercase fw-semibold mb-0"
                                style="font-size: 0.9rem; letter-spacing: 2px;">
                                {{ __('messages.stats_projects') }}
                            </p>
                        </div>

                        <div class="col-auto me-lg-5 me-4">
                            <h2 class="display-6 fw-black mb-1" style="color: var(--sharesa-green);">30<span
                        ...
                        <div class="col-auto">
                            <div class="d-flex align-items-center">
                                <h2 class="display-6 fw-black text-white mb-1">4.9</h2>
                                <span class="ms-2 mb-2" style="color: #ffc107; font-size: 1.2rem;">★</span>
                            </div>
                            <p class="text-white-50 text-uppercase fw-semibold mb-0"
                                style="font-size: 0.9rem; letter-spacing: 2px;">
                ...
                <div class="col-lg-5 d-none d-lg-block">
                    <div class="position-relative">
                        ...
                        <div class="p-2 rounded-4 bg-white bg-opacity-10 border border-white border-opacity-10 shadow-2xl overflow-hidden shadow-lg"
                            ...
                            <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=2015&auto=format&fit=crop"
                                alt="Digital Experience" class="img-fluid rounded-3 shadow-sm">
                        </div>

                        {{-- Floating Activity Badge --}}
                        <div class="position-absolute top-0 start-0 bg-white p-3 rounded-4 shadow-xl m-n3 animate-float d-flex align-items-center gap-3"
                            style="max-width: 220px; z-index: 2;">
    ...
    <section class="py-5 bg-white">
        <div class="container py-5">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div
                        class="p-4 border border-light bg-white shadow-lg rounded-4 h-100 text-center hover-card transform-scale">
        ...
        <div class="container py-5">
            ...
            <div class="d-flex justify-content-between align-items-end mb-5">
                <div>
                    ...
                    <h2 class="fw-bold display-6 mb-0 mt-2" style="color: var(--sharesa-dark);">
                        {{ __('messages.featured_title') }}</h2>
                </div>
                        ...
                        <div class="card border-0 rounded-4 overflow-hidden shadow-sm h-100 group hover-card">
                            ...
                            <div class="position-relative overflow-hidden">
                                ...
                                <img src="{{ $project->image ?? 'https://placehold.co/800x600/1e2a39/00ff8c?text=Sharesa+Project' }}"
                                    class="card-img-top transition-transform duration-500" alt="{{ $project->title }}"
            ...
            <div class="text-center mt-4 d-md-none">
                <a href="{{ url('/portfolios') }}" class="btn btn-outline-dark rounded-pill px-4 fw-bold w-100">View All
                    Works</a>
            </div>
        </div>
    </section>
        ...
        <div class="container py-4">
            <div class="rounded-5 p-5 text-center text-white position-relative overflow-hidden border border-white border-opacity-10"
                ...
                <div class="position-relative z-1 col-lg-8 mx-auto">
                    ...
                    <a href="#"
                        class="btn btn-sharesa-primary btn-lg rounded-pill px-5 py-3 shadow-lg hover-scale fw-bold text-uppercase tracking-widest wa-track"
